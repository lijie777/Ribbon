...
QT_INIT_METAOBJECT const QMetaObject SARibbonControlButton::staticMetaObject = { {
    &QToolButton::staticMetaObject,
    qt_meta_stringdata_SARibbonControlButton.data,
    qt_meta_data_SARibbonControlButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
