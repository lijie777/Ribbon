...
void SAWindowButtonGroup::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<SAWindowButtonGroup *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject SAWindowButtonGroup::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_SAWindowButtonGroup.data,
    qt_meta_data_SAWindowButtonGroup,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
struct qt_meta_stringdata_SAWindowToolButton_t {
    QByteArrayData data[1];
    char stringdata0[19];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_SAWindowToolButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_SAWindowToolButton_t qt_meta_stringdata_SAWindowToolButton = {
    {
QT_MOC_LITERAL(0, 0, 18) // "SAWindowToolButton"
...
static const uint qt_meta_data_SAWindowToolButton[] = {
...
void SAWindowToolButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
QT_INIT_METAOBJECT const QMetaObject SAWindowToolButton::staticMetaObject = { {
    &QToolButton::staticMetaObject,
    qt_meta_stringdata_SAWindowToolButton.data,
    qt_meta_data_SAWindowToolButton,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *SAWindowToolButton::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *SAWindowToolButton::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_SAWindowToolButton.stringdata0))
        return static_cast<void*>(this);
    return QToolButton::qt_metacast(_clname);
}

int SAWindowToolButton::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
